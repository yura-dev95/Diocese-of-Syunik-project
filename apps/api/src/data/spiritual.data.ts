...
export const saints: SaintRecord[] = [
  { id: 'saint-1', slug: 'saint-gregory-illuminator', name: 'Սուրբ Գրիգոր Լուսավորիչ', biography: 'Հայոց առաջին Հայրապետը և Հայաստանի լուսավորիչը։', feastDate: '06-27', imageUrl: 'https://images.unsplash.com/photo-1548625361-58a9b86aa83b?auto=format&fit=crop&w=900&q=85', patronOf: 'Հայոց աշխարհի' },
  { id: 'saint-2', slug: 'saint-mesrop-mashtots', name: 'Սուրբ Մեսրոպ Մաշտոց', biography: 'Հայոց գրերի ստեղծողը, վարդապետ և լուսավորիչ։', feastDate: '02-17', imageUrl: 'https://images.unsplash.com/photo-1544947950-fa07a98d237f?auto=format&fit=crop&w=900&q=85', patronOf: 'Կրթության և գրերի' },
  { id: 'saint-3', slug: 'saint-tatevos', name: 'Սուրբ Թադեոս առաքյալ', biography: 'Հայաստանում քրիստոնեություն քարոզած առաքյալներից։', feastDate: '12-05', imageUrl: 'https://images.unsplash.com/photo-1520637836862-4d197d17c93a?auto=format&fit=crop&w=900&q=85' },
];
...
export const choirs: ChoirRecord[] = [
  ...
  { id: 'choir-2', slug: 'tatev-children-choir', name: 'Տաթև մանկական երգչախումբ', description: 'Հոգևոր երգի և հայկական երաժշտական ժառանգության կրթական խումբ։', imageUrl: 'https://images.unsplash.com/photo-1509824227185-9c5a01ceba0d?auto=format&fit=crop&w=1200&q=85', conductor: 'Մարիամ Ավետիսյան', location: 'Տաթև' },
];
export const mediaItems: MediaItemRecord[] = [
  { id: 'media-1', slug: 'silence-of-tatev', title: 'Տաթևի լռությունը. ինչպե՞ս լսել աղոթքը', description: '«Սյունյաց շունչ» զրույց հոգևոր լռության մասին։', mediaType: 'PODCAST', coverUrl: 'https://images.unsplash.com/photo-1605537964076-3cb0ea2ff329?auto=format&fit=crop&w=1200&q=85', duration: '28։42', publishedAt: '2026-06-01' },
  ...
  { id: 'media-4', slug: 'one-day-at-tatev', title: 'Մեկ օր Տաթևում', description: 'Տեսապատում վանական համալիրի առօրյայից։', mediaType: 'VLOG', coverUrl: 'https://images.unsplash.com/photo-1568322503342-2b9c7f5efb1b?auto=format&fit=crop&w=1200&q=85', duration: '12։30', publishedAt: '2026-04-18' },
  { id: 'media-5', slug: 'morning-hymn', title: 'Առավոտ լուսո', description: 'Հոգևոր երգի ձայնագրություն։', mediaType: 'CHOIR_RECORDING', coverUrl: 'https://images.unsplash.com/photo-1509824227185-9c5a01ceba0d?auto=format&fit=crop&w=1200&q=85', duration: '04։52', publishedAt: '2026-03-14', choirSlug: 'tatev-children-choir' },
];
